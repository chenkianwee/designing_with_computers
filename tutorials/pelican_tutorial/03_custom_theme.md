...
If you are not interested in learning how to customize your theme you can choose one of the <a href = "https://github.com/getpelican/pelican-themes" target = "_blank">pelican themes</a> and apply it to your website. The theme of this website can be found <a href = "https://github.com/chenkianwee/dwc_bootstrap5" target = "_blank">here</a>. Jump to the next tutorial on [how to host your site on github pages](./04_ghpages.md).
...
```{image} images/pelican_tut2_0.png
:width: 100%
:align: center
```
...
```{image} images/pelican_tut2_1.png
:width: 50%
:align: center
```
...
```{image} images/pelican_tut2_3.png
:width: 100%
:align: center
```
